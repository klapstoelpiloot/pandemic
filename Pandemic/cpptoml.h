...
{
    using return_type = option<vector<std::shared_ptr<array>>>;
};
...
class array : public base
{
  public:
     ...
     */
    using iterator = vector<std::shared_ptr<base>>::iterator;

    /**
     * arrays can be iterated over.  Const version.
     */
    using const_iterator = vector<std::shared_ptr<base>>::const_iterator;
     ...
     */
    vector<std::shared_ptr<base>>& get()
    {
        return values_;
    }
     ...
     */
    const vector<std::shared_ptr<base>>& get() const
    {
        return values_;
    }
     ...
     */
    template <class T>
    vector<std::shared_ptr<value<T>>> array_of() const
    {
        vector<std::shared_ptr<value<T>>> result(values_.size());
     ...
     */
    vector<std::shared_ptr<array>> nested_array() const
    {
        vector<std::shared_ptr<array>> result(values_.size());
  ...
  private:
    ...
    vector<std::shared_ptr<base>> values_;
};
...
{
    vector<std::shared_ptr<array>> result;
    result.reserve(values_.size());
...
class table_array : public base
{
  ...
  public:
     ...
     * arrays can be iterated over
     */
    using iterator = vector<std::shared_ptr<table>>::iterator;

    /**
     * arrays can be iterated over.  Const version.
     */
    using const_iterator = vector<std::shared_ptr<table>>::const_iterator;
    ...
    vector<std::shared_ptr<table>>& get()
    {
        return array_;
    }

    const vector<std::shared_ptr<table>>& get() const
    {
        return array_;
    }
  ...
  private:
    ...
    vector<std::shared_ptr<table>> array_;
...
class table : public base
{
  ...
  private:
    ...
    vector<std::string> split(const std::string& value,
